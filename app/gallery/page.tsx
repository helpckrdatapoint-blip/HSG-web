...
import { ArrowLeft, Images, Sparkles, Camera } from "lucide-react";
      ...
      <div className="relative z-10 px-6 max-w-2xl mx-auto text-center">
        ...
        <div className="mx-auto mb-10 relative">
           <div className="w-32 h-32 mx-auto bg-gradient-to-tr from-zinc-900 to-zinc-800 rounded-3xl border border-white/10 flex items-center justify-center shadow-2xl shadow-blue-900/20 relative group">
              ...
              <Camera size={48} className="text-zinc-400 group-hover:text-white transition-colors duration-300" strokeWidth={1.5} />
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white">
            Curating Our <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Best Moments</span>
          </h1>

          <p className="text-lg text-zinc-400 leading-relaxed">
            We are currently compiling high-quality photographs from our recent camps, treks, and community service drives. The visual journey of HSG CMRIT will be live soon.
          </p>
        </div>
